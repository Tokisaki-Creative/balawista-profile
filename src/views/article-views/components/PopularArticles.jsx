...
import { DataPopularArticle } from "../constant"
        ...
        <section className="my-32">
            <div className="container">
                ...
                <div data-AOS="fade-down" data-aos-duration="1200">
                    <p className="font-semibold text-primary text-base">Pilihan Editor</p>
                    <h2 className="mt-2 text-2xl md:text-[32px] font-extrabold text-secondary leading-8 md:leading-10">Artikel Terpopuler</h2>
                </div>

                {/* Content */}
                <div className="mt-4 md:mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
                    {DataPopularArticle.map((items) => (
                    <div data-AOS="fade-up" data-aos-duration={items.duration}>
                        <a href={items.link}>
                            <img className="rounded-t-lg h-[200px] w-full" src={items.image} alt="article-image" />
                        </a>
