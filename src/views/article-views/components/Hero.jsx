    ...
    return (
        <section className="w-full h-screen">
            ...
            <Flex data-AOS="fade-down" data-aos-duration="1600" className="absolute top-0 w-full h-full flex-col justify-center items-center gap-y-4">
                ...
                <p className=" text-captions text-base md:text-lg text-center">Ketikkan keyword di bawah untuk mencari artikel terkait!</p>                
                ...
                <form className="md:w-[628px] w-[400px]">
                    <div className="flex">
                        <div class="relative w-full">
                            ...
                            <input type="text" class="bg-white border border-gray-300 text-secondary text-sm rounded-s-lg focus:ring-primary focus:border-primary focus:outline-none block w-full ps-10 p-2.5" placeholder="Ketik judul artikel.." required />
                        </div>
