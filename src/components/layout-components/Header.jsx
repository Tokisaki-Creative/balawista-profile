...
const Header = () => {
  ...
  function Linkness(type = null) {
    let classes =
      "md:text-sm lg:text-base hover:text-primary transition-all duration-500";
        ...
        <nav className="flex items-center justify-between py-4">
          ...
          >
            <ul className="flex flex-col gap-5 font-jakartaSans">
              ...
              <li>
                <a href="/kegiatan" className="nav-item-sm">
                  Kegiatan
                </a>
              </li>
              <li>
                <a href="/tentang-kami" className="nav-item-sm">
                  Tentang Kami
                </a>
              </li>
            </ul>
          ...
          <ul className="md:flex hidden gap-8">
            <li className="flex flex-col gap-[2px]">
              <a href="/" className={Linkness("")}>
                Beranda
              </a>
              <div className={underlineNav("")}></div>
            </li>
            <li className="flex flex-col gap-[2px]">
              <a href="/kegiatan" className={Linkness("kegiatan")}>
                Kegiatan
              </a>
              <div className={underlineNav("kegiatan")}></div>
            </li>
            <li className="flex flex-col gap-[2px]">
              <a href="/tentang-kami" className={Linkness("tentang-kami")}>
                Tentang Kami
              </a>
